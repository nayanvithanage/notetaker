...
# Copy frontend build from frontend stage (Angular 17+ puts files in browser subfolder)
COPY --from=frontend-builder /app/frontend/dist/notetaker-web/browser ./wwwroot
